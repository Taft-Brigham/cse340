...
CONSTRAINT classisfication_pk PRIMARY KEY (classification_id)
);    

-- Table stricture for table inventory
...
-- Create relationshaip between classification and inventroty tables 
